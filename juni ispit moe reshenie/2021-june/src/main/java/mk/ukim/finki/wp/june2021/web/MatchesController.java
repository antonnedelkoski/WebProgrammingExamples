...
public class MatchesController {
    ...
    public String showMatches(@RequestParam(required = false) Double price,
                              ...
                              Model model) {
        List<Match> matches;
        List<MatchLocation> matchLocations =this.matchLocationService.listAll();
        ...
        model.addAttribute("matchLocations",matchLocations);
    ...
    public String showEdit(@PathVariable Long id,Model model) {
        Match matches = this.matchService.findById(id);
        List<MatchLocation> matchLocations=this.matchLocationService.listAll();
